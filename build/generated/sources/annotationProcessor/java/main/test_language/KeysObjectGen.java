...
import test_language.InstrumentationTestLanguage.KeysObject;

@GeneratedBy(KeysObject.class)
final class KeysObjectGen {

    private static final LibraryFactory<DynamicDispatchLibrary> DYNAMIC_DISPATCH_LIBRARY_ = LibraryFactory.resolve(DynamicDispatchLibrary.class);

    static  {
        LibraryExport.register(KeysObject.class, new InteropLibraryExports());
    }

    private KeysObjectGen() {
    }
    ...
    static class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private InteropLibraryExports() {
            super(InteropLibrary.class, KeysObject.class, false, false, 0);
        }

        @Override
        protected InteropLibrary createUncached(Object receiver) {
            assert receiver instanceof KeysObject;
        ...
        static class Cached extends InteropLibrary {
            ...
            private final Class<? extends KeysObject> receiverClass_;

            protected Cached(Object receiver) {
                KeysObject castReceiver = ((KeysObject) receiver) ;
        ...
        static class Uncached extends InteropLibrary {
            ...
            protected Uncached(Object receiver) {
                this.receiverClass_ = ((KeysObject) receiver).getClass();
            }
            ...
            public boolean hasArrayElements(Object receiver) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .hasArrayElements();
            }
            ...
            public boolean isArrayElementReadable(Object receiver, long index) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .isArrayElementReadable(index);
            }
            ...
            public long getArraySize(Object receiver) throws UnsupportedMessageException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .getArraySize();
            }
            ...
            public Object readArrayElement(Object receiver, long index) throws UnsupportedMessageException, InvalidArrayIndexException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .readArrayElement(index);
            }
            ...
            public boolean hasLanguage(Object receiver) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .hasLanguage();
            }
            ...
            public Class<? extends TruffleLanguage<?>> getLanguage(Object receiver) throws UnsupportedMessageException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .getLanguage();
            }
            ...
            public Object toDisplayString(Object receiver, boolean allowSideEffects) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((KeysObject) receiver) .toDisplayString(allowSideEffects);
            }
