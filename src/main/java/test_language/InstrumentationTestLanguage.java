...
@ProvidedTags({ExpressionTag.class, InstrumentationTestLanguage.DefineTag.class, InstrumentationTestLanguage.LoopTag.class,
        StatementTag.class, StandardTags.CallTag.class, RootTag.class, RootBodyTag.class,
        StandardTags.TryBlockTag.class, InstrumentationTestLanguage.BlockTag.class, InstrumentationTestLanguage.ConstantTag.class})
public class InstrumentationTestLanguage extends TruffleLanguage<InstrumentContext> {
    ...
    public static final Class<? extends Tag> EXPRESSION = ExpressionTag.class;
    public static final Class<? extends Tag> DEFINE = DefineTag.class;
    public static final Class<? extends Tag> LOOP = LoopTag.class;
    public static final Class<? extends Tag> STATEMENT = StatementTag.class;
    public static final Class<? extends Tag> CALL = StandardTags.CallTag.class;
    public static final Class<? extends Tag> ROOT_BODY = RootBodyTag.class;
    public static final Class<? extends Tag> ROOT = RootTag.class;
    ...
    private static class CallNode extends InstrumentedNode {
        ...
        public Object execute(VirtualFrame frame) {
            ...
            System.out.println("CALL EXECUTED LMAO");
    ...
    public static class TypeSpecializedNode extends InstrumentedNode implements InstrumentableNode {
        ...
        public final boolean hasTag(Class<? extends Tag> tag) {
            if (tag.equals(StatementTag.class)) {
                return true;
            }
    ...
    static class MaterializeChildExpressionNode extends StatementNode {
        ...
        public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
            if (materializedTags.contains(ExpressionTag.class)) {
    ...
    static class MaterializeChildStatementNode extends StatementNode {
        ...
        public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
            if (materializedTags.contains(StatementTag.class)) {
    ...
    static class MaterializeChildStatementAndExpressionSeparatelyNode extends StatementNode {
        ...
        public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
            ...
            if (materializedTags.contains(StatementTag.class) && materializedTags.contains(ExpressionTag.class)) {
            ...
            } else if (materializedTags.contains(StatementTag.class)) {
            ...
            } else if (materializedTags.contains(ExpressionTag.class)) {
    ...
    static class MaterializeChildStatementAndExpressionNode extends StatementNode {
        ...
        public InstrumentableNode materializeInstrumentableNodes(Set<Class<? extends Tag>> materializedTags) {
            if (materializedTags.contains(ExpressionTag.class) || materializedTags.contains(StatementTag.class)) {
...
class InstrumentContext {
    ...
    final InstrumentationTestLanguage.FunctionsObject callFunctions = new InstrumentationTestLanguage.FunctionsObject();
    final Env env;
